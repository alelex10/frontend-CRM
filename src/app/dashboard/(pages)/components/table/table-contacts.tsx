...
export const fetchData = async ({ setContacts, setError, setIsLoading }: FetchProps) => {
	setIsLoading(async () => {
		const dataList = await contactList({ query: {} });
...
export default function EnhancedTableContacts({ headCells }: Props) {

...
export interface HeadCell {
	...
	id: keyof Compani | keyof Contact; // Usa keyof Compani para que sea tipado correctamente
	label: string;
	numeric: boolean;
}
export const companiHeadCells: readonly HeadCell[] = [
	{
		id: "id",
		numeric: true,
...
export const contactHeadCell: readonly HeadCell[] = [
	{
		id: "id",
		numeric: true,
		disablePadding: false,
